...
A escolha do projeto que o grupo de estudantes desenvolverá é determinado pela soma do último dígito do RA (número de matrícula) de cada membro do grupo. Se a soma desses dígitos resultar em um número par, então o grupo deve fazer o [Projeto 1](Projeto1.md); se resultar em um número ímpar, o grupo deverá fazer o [Projeto 2](Projeto2.md).
